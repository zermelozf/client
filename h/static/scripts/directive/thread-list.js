...
function ThreadListController($scope, VirtualThreadList) {
  ...
  /**
   * Export `scrollIntoView` for use by parent controllers.
   */
  this.ctrl = this.ctrl || {};
  this.ctrl.scrollIntoView = scrollIntoView;
...
module.exports = function () {
  return {
    ...
    scope: {
      /**
       * Controller object which the thread list exposes methods on for use by
